<aside class="w-64 border-r border-gray-200 flex flex-col overflow-y-auto shadow-md" style="background: linear-gradient(180deg, #667eea 0%, #764ba2 100%);">
    ...
    <nav class="flex-1 p-4 space-y-2">
        ...
        <a href="{{ route('stock-transfer.cashier.sub-stock') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('stock-transfer.cashier.sub-stock') ? 'bg-white/25 text-white border-l-4 border-white font-semibold' : 'text-white/80 hover:bg-white/15 hover:text-white' }} rounded-lg transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </svg>
