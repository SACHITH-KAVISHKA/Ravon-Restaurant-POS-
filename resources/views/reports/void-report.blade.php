...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 overflow-y-auto">
        <div class="container mx-auto px-4 py-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold bg-gradient-to-r from-[#ef4444] to-[#dc2626] bg-clip-text text-transparent mb-2">Void Report</h1>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-md p-6 mb-6">
                <form method="GET" action="{{ route('void-report.index') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <!-- Cashier Filter -->
                        <div>
                            <label for="cashier_id" class="block text-sm font-medium text-gray-700 mb-2">
                                Cashier
                            </label>
                            <select
                                id="cashier_id"
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a
                                href="{{ route('void-report.export', request()->query()) }}"
                ...
                <div class="table-responsive">
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-[#ef4444] to-[#dc2626]">
                            <tr>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Void #</th>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Item</th>
                                <th class="px-6 py-4 text-center text-xs font-semibold text-white uppercase tracking-wider">Qty</th>
                                <th class="px-6 py-4 text-right text-xs font-semibold text-white uppercase tracking-wider">Amount</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Cashier</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Supervisor</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-red-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center justify-center w-8 h-8 bg-red-100 text-red-700 font-bold rounded-full">
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-600 text-lg">No void records found for the selected filters</p>
                                        <p class="text-gray-500 text-sm mt-1">Great! No items have been voided in this period.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-xl shadow-2xl border border-gray-200 max-w-lg w-full">
            ...
            <div class="flex items-center justify-end px-6 py-4 border-t border-gray-200 bg-gray-50">
                <button onclick="closeModal()" class="bg-white hover:bg-gray-100 text-gray-700 font-semibold py-2 px-6 rounded-lg transition border border-gray-300">
                    Close
                </button>
            </div>
        </div>
