    ...
    <div id="itemDetailsModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20">
            <div class="bg-white rounded-xl shadow-2xl max-w-6xl w-full border border-gray-300">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <h6 class="text-lg font-semibold text-gray-800">Item: <span id="modalItemName"
                                class="text-purple-600"></span></h6>
                    </div>

                    <div class="flex justify-end mb-4">
                        <button type="button" id="exportDetailsBtn"
                            class="bg-green-600 hover:bg-green-600/90 text-white font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            ...
                            <tbody id="detailsTableBody" class="divide-y divide-gray-200">
                                <tr>
                                    <td colspan="6" class="text-center py-8">
                                        <div class="flex flex-col items-center justify-center">
                                            <div
                                                class="animate-spin rounded-full h-10 w-10 border-b-2 border-purple-600 mb-3">
                                            </div>
