        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-700">
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-400 text-lg">Dashboard widgets can be added here</p>
                    <p class="text-gray-500 text-sm mt-2">Use the sidebar to navigate to different sections</p>
                </div>
            </div>
        </div>
    </div>
