                                ...
                                <div class="view-mode-{{ $modifier->id }}">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex gap-3">
                                            <button onclick="toggleEditMode({{ $modifier->id }})" class="flex items-center gap-1 text-purple-600 hover:text-purple-800 text-xs font-medium">
                                            ...
                                            <form action="{{ route('menu.modifiers.destroy', $modifier) }}" method="POST" onsubmit="return confirm('Delete this portion?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="flex items-center gap-1 text-red-600 hover:text-red-800 text-xs font-medium">
                                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
